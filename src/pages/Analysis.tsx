      ...
      <div className="p-6 max-w-6xl mx-auto space-y-6" ref={reportRef}>
        ...
        <div className="flex items-start gap-3 rounded-lg border border-destructive/30 bg-destructive/5 p-4">
          ...
          <div className="text-sm">
            <p className="font-medium text-destructive">AI-Generated Analysis — Not for Clinical Use</p>
            <p className="text-muted-foreground">These results are generated by a mock AI system for demonstration purposes. Always consult a qualified radiologist for clinical diagnosis.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <Card>
              ...
              <CardContent>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xl font-bold">{result.primary_diagnosis}</span>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">{result.clinical_summary}</p>
              </CardContent>
            </Card>
          </div>
        </div>
